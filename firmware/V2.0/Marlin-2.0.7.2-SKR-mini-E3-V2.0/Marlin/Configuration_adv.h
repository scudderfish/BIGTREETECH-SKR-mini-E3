...
#define CONTROLLERFAN_SPEED_IDLE 10    // (0-255) Idle speed, used when motors are disabled
...
#define PAUSE_PARK_RETRACT_LENGTH 2          // This short retract is done immediately, before parking the nozzle.
#define FILAMENT_CHANGE_UNLOAD_FEEDRATE 10   // (mm/s) Unload filament feedrate. This can be pretty fast.
#define FILAMENT_CHANGE_UNLOAD_ACCEL 25      // (mm/s^2) Lower acceleration may allow a faster feedrate.
#define FILAMENT_CHANGE_UNLOAD_LENGTH 400    //   Set to 0 for manual unloading.
#define FILAMENT_CHANGE_SLOW_LOAD_FEEDRATE 6 // (mm/s) Slow move when starting load.
#define FILAMENT_CHANGE_SLOW_LOAD_LENGTH 0   // 0 to disable start loading and skip to fast load only
#define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE 6 // (mm/s) Load filament feedrate. This can be pretty fast.
#define FILAMENT_CHANGE_FAST_LOAD_ACCEL 25   // (mm/s^2) Lower acceleration may allow a faster feedrate.
#define FILAMENT_CHANGE_FAST_LOAD_LENGTH 350 //   For direct drive, the full length of the nozzle.
//#define ADVANCED_PAUSE_CONTINUOUS_PURGE       // Purge continuously up to the purge length until interrupted.
#define ADVANCED_PAUSE_PURGE_FEEDRATE 3 // (mm/s) Extrude feedrate (after loading). Should be slower than load feedrate.
#define ADVANCED_PAUSE_PURGE_LENGTH 50  //   until extrusion is consistent, and to purge old filament.
...
#define X_OVERCURRENT 2000 // (mA) Current where the driver detects an over current#define X_STALLCURRENT 1500#define X_MAX_VOLTAGE 127   // 0-255, Maximum effective voltage seen by stepper - not used by L6474
...
#define MAX7219_ROTATE 0       // connector at:  right=0   bottom=-90  top=90  left=180
...
#define MAX7219_DEBUG_PLANNER_QUEUE 0 // tweaks made to the configuration are affecting the printer in real-time.
#endif
